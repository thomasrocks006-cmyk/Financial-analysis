...
INVESTMENT_THEMES = {
    "ai_infrastructure": {
        ...
        "default_tickers": ["NVDA", "AVGO", "TSM", "CEG", "VST", "GEV", "PWR", "ETN", "APH", "FIX", "FCX", "NXT"],
    ...
    "growth_innovation": {
        ...
        "default_tickers": ["NVDA", "TSLA", "CRM", "SNOW", "PLTR", "NET", "CRWD", "DDOG", "MDB", "COIN"],
    ...
    "clean_energy": {
        ...
        "default_tickers": ["NEE", "ENPH", "FSLR", "CEG", "VST", "GEV", "NXT", "PLUG", "BE", "SEDG"],
...
class ClientProfile:
    ...
    def get_portfolio_constraints(self) -> dict:
        ...
        return {
            "max_single_position_pct": min(self.max_single_position_pct, risk["max_single_position_pct"]),
