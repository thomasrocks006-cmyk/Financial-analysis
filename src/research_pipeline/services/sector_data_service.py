...
_SYNTHETIC_DATA: dict[str, dict[str, Any]] = {
    # Compute
    "NVDA":  {"revenue_ttm": 79_300, "revenue_yoy_pct": 122.4, "gross_margin": 0.745, "ebitda_margin": 0.558, "eps_ttm": 11.93, "forward_pe": 37.2, "ev_ebitda": 53.1, "gics_sector": "Information Technology"},
    "AVGO":  {"revenue_ttm": 35_820, "revenue_yoy_pct": 47.3,  "gross_margin": 0.675, "ebitda_margin": 0.612, "eps_ttm": 21.06, "forward_pe": 27.4, "ev_ebitda": 30.2, "gics_sector": "Information Technology"},
    "AMD":   {"revenue_ttm": 22_680, "revenue_yoy_pct": 13.7,  "gross_margin": 0.511, "ebitda_margin": 0.093, "eps_ttm": 0.53,  "forward_pe": 41.1, "ev_ebitda": 22.4, "gics_sector": "Information Technology"},
    "TSM":   {"revenue_ttm": 76_500, "revenue_yoy_pct": 33.9,  "gross_margin": 0.535, "ebitda_margin": 0.631, "eps_ttm": 6.11,  "forward_pe": 22.1, "ev_ebitda": 18.5, "gics_sector": "Information Technology"},
    "ANET":  {"revenue_ttm": 6_000,  "revenue_yoy_pct": 19.8,  "gross_margin": 0.644, "ebitda_margin": 0.356, "eps_ttm": 8.14,  "forward_pe": 35.5, "ev_ebitda": 29.3, "gics_sector": "Information Technology"},
    # Power / Energy
    "CEG":   {"revenue_ttm": 23_400, "revenue_yoy_pct": 6.2,   "gross_margin": 0.312, "ebitda_margin": 0.395, "eps_ttm": 7.22,  "forward_pe": 28.4, "ev_ebitda": 20.1, "gics_sector": "Utilities"},
    "VST":   {"revenue_ttm": 14_100, "revenue_yoy_pct": 16.8,  "gross_margin": 0.283, "ebitda_margin": 0.351, "eps_ttm": 5.81,  "forward_pe": 23.7, "ev_ebitda": 16.8, "gics_sector": "Utilities"},
    "GEV":   {"revenue_ttm": 24_900, "revenue_yoy_pct": 9.1,   "gross_margin": 0.261, "ebitda_margin": 0.187, "eps_ttm": 3.42,  "forward_pe": 31.2, "ev_ebitda": 21.4, "gics_sector": "Industrials"},
    "NLR":   {"revenue_ttm": None,   "revenue_yoy_pct": None,  "gross_margin": None,  "ebitda_margin": None,  "eps_ttm": None,  "forward_pe": None, "ev_ebitda": None, "gics_sector": "Utilities"},
    # Infrastructure
    "PWR":   {"revenue_ttm": 21_800, "revenue_yoy_pct": 15.3,  "gross_margin": 0.163, "ebitda_margin": 0.118, "eps_ttm": 4.88,  "forward_pe": 41.3, "ev_ebitda": 24.9, "gics_sector": "Industrials"},
    "ETN":   {"revenue_ttm": 24_400, "revenue_yoy_pct": 12.4,  "gross_margin": 0.381, "ebitda_margin": 0.248, "eps_ttm": 9.62,  "forward_pe": 29.8, "ev_ebitda": 22.3, "gics_sector": "Industrials"},
    "HUBB":  {"revenue_ttm": 5_500,  "revenue_yoy_pct": 9.7,   "gross_margin": 0.372, "ebitda_margin": 0.219, "eps_ttm": 16.41, "forward_pe": 25.4, "ev_ebitda": 17.6, "gics_sector": "Industrials"},
    "APH":   {"revenue_ttm": 15_200, "revenue_yoy_pct": 38.9,  "gross_margin": 0.339, "ebitda_margin": 0.285, "eps_ttm": 1.73,  "forward_pe": 34.6, "ev_ebitda": 25.7, "gics_sector": "Information Technology"},
    "FIX":   {"revenue_ttm": 5_700,  "revenue_yoy_pct": 18.2,  "gross_margin": 0.187, "ebitda_margin": 0.102, "eps_ttm": 5.53,  "forward_pe": 35.1, "ev_ebitda": 19.8, "gics_sector": "Industrials"},
    "NXT":   {"revenue_ttm": 2_200,  "revenue_yoy_pct": 24.6,  "gross_margin": 0.221, "ebitda_margin": 0.135, "eps_ttm": 1.97,  "forward_pe": 28.7, "ev_ebitda": 15.9, "gics_sector": "Industrials"},
    # Materials
    "FCX":   {"revenue_ttm": 22_800, "revenue_yoy_pct": 5.8,   "gross_margin": 0.287, "ebitda_margin": 0.411, "eps_ttm": 1.48,  "forward_pe": 17.3, "ev_ebitda": 10.2, "gics_sector": "Materials"},
    "BHP":   {"revenue_ttm": 55_700, "revenue_yoy_pct": -3.1,  "gross_margin": 0.441, "ebitda_margin": 0.489, "eps_ttm": 2.87,  "forward_pe": 12.4, "ev_ebitda": 8.1,  "gics_sector": "Materials"},
    # ASX names (stub — FMP ticker format differs, synthetic used here)
    "CBA.AX": {"revenue_ttm": 27_800, "revenue_yoy_pct": 4.1,  "gross_margin": None,  "ebitda_margin": 0.421, "eps_ttm": 6.48,  "forward_pe": 21.3, "ev_ebitda": None, "gics_sector": "Financials"},
    "BHP.AX": {"revenue_ttm": 55_700, "revenue_yoy_pct": -3.1, "gross_margin": 0.441, "ebitda_margin": 0.489, "eps_ttm": 2.87,  "forward_pe": 12.4, "ev_ebitda": 8.1,  "gics_sector": "Materials"},
    "CSL.AX": {"revenue_ttm": 14_300, "revenue_yoy_pct": 5.6,  "gross_margin": 0.551, "ebitda_margin": 0.231, "eps_ttm": 4.82,  "forward_pe": 29.5, "ev_ebitda": 21.7, "gics_sector": "Health Care"},
}
...
class SectorDataService:
    ...
    def _fetch_fmp(self, ticker: str) -> "SectorDataResult":
        ...
        revenue_ttm = float(revenue_per_share * shares) / 1e6 if revenue_per_share and shares else None
        ...
        return SectorDataResult(
            ...
            gross_margin=float(m["grossProfitMarginTTM"]) if m.get("grossProfitMarginTTM") else None,
            ebitda_margin=float(m["ebitdaPerShareTTM"]) / float(revenue_per_share) if m.get("ebitdaPerShareTTM") and revenue_per_share else None,
            ...
            ev_ebitda=float(m["enterpriseValueOverEBITDATTM"]) if m.get("enterpriseValueOverEBITDATTM") else None,
            is_live=True,
